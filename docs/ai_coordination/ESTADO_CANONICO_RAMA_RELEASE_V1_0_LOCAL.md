...
- La corrección funcional quedó en `74f64f5`; el despliegue productivo vigente es `d1a7c0e` mediante artefacto local directo. La prueba humana de `LAB-20260720-001` dejó `RESULTADOS_LISTOS`, `GLUCOSA=95`, PDF persistido y aprobación humana verdadera.
