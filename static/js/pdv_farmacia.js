...
window.enviarWhatsApp = function(){
    ...
    .catch(function(error){try{win.close();}catch(_e){console.debug('[PDV] No se pudo cerrar la ventana del ticket:', _e);} alert(error.message||'No se pudo preparar el ticket digital.');});
};
