...
def api_generar_cupon(request):
    ...
    try:
        ...
        logging.getLogger(__name__).exception("Error inesperado en api_generar_cupon (views_legacy.py)")
...
def dashboard_campanas(request):
    ...
    for c in campanas:
        ...
        try:
            ...
            logging.getLogger(__name__).exception("Error inesperado en dashboard_campanas (views_legacy.py)")
            pass
        ...
        for p in pacientes_inactivos:
            ...
            if p.telefono:
                ...
                try:
                    ...
                    logging.getLogger(__name__).exception("Error inesperado en api_detectar_pacientes_inactivos (views_legacy.py)")
                    pass
            resultado.append({
                'id': p.id,
