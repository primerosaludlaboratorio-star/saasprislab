...
urlpatterns = [
    ...
    path('api/compra/analizar/', views.api_analizar_compra, name='api_analizar_compra'),
    path('api/compra/confirmar/', views.api_confirmar_compra, name='api_confirmar_compra'),
